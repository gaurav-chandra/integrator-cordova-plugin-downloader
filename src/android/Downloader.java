...
public class Downloader extends CordovaPlugin {
  ...
  private void sendDownloadResult(String locationUri) {
      if(this.downloadReceiverCallbackContext != null){
          ...
          /*Added by Gaurav*/
          final Intent intent = new Intent("fileDownloaded");
          Bundle b = new Bundle();
          b.putString( "file_name", this.file_name);
          b.putString( "file_location", locationUri);
  ...
  protected DownloadManager.Request deserialiseRequest(JSONObject obj) throws JSONException {
    ...
    /*Added by Gaurav*/
    this.file_name = obj.optString("description");
    /*------------------------*/
